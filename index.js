...
const inputKupac = getElementById('kupac')
const inputDino = getElementById('select-dino')

const selectDino =document.getElementById('select-dino')
const labelName = document.createElement('label')
selectDino.appendChild(labelName2e)
...
const divContainer = document.getElementById('item-container')
